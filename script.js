...
if (screen.width > 768) {
  ...
  cartBox.setAttribute(
    "style",
    " width:20vw; height:14vw; border-radius:8px; position:absolute; top:50px; right:0px; z-index:50; background:white; box-shadow:-5px 5px 20px hsl(220, 14%, 75%); display:none"
  );
} else {
  document.body.appendChild(cartBox);
  cartBox.setAttribute(
    "style",
    " width:90%; height:300px; border-radius:8px; position:absolute; top:100px; left:5vw; z-index:50; background:white; display:none"
  );
}
...
notification.setAttribute(
  "style",
  " padding:1px 3px;border-radius:50%; background-color:hsl(26, 100%, 55%); font-size:10px;position:absolute;top:10px; display:none;"
);
...
close.addEventListener("mousemove", function () {
  close.src = "images/icon-close copy.svg";
});
...
addToCart.addEventListener("click", function () {
  ...
  if (screen.width > 768) {
    ...
    imageP.src = "images/image-product-1.jpg";
